...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  | Raise|   N  |   M  |   ,  |   .  |   /  |Shift |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Alfred|  `   | Lower| Alt  | LGUI |Space |Bksp |Tab   |Enter | RGUI | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      LALT(KC_SPC),  KC_GRV,  LOWER, KC_LALT, KC_LGUI,    KC_SPC,   KC_BSPC,  KC_TAB,  KC_ENT,   RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, RGB_TOG, RGB_MOD, RGB_RMOD, RGB_SPD, RGB_SPI, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
